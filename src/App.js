    ...
    return (
        ...
        <div className='page-wrapper'>
          ...
          <section className='hero-wrapper'>
            ...
            <div className='hero-content'>
              <Title type='hero-name'>Hello, I'm Robert Maulana</Title>
              <Title type='hero-activity'>Consult, Design, and Develop Websites</Title>
              <Title type='hero-subtitle'>Have something great in mind? <br />Feel free to contact me. <br />I'll help you to make it happen.</Title>
      ...
      incarceration. Outcomes big data, fairness, social game-changer.</Title>
          ...
          <section className='footer'>
            <Title type='footer-copyright'>© 2019 Robert Maulana. All Right reserved</Title>
          </section>
